                    ...
                    <form wire:submit.prevent="import" class="flex h-full flex-col divide-y divide-gray-200 bg-white shadow-xl">
                        <div class="py-6 px-4 sm:px-6">
                            <div class="flex items-center justify-between">
                                <h2 class="text-lg font-medium">Importar arquivo CSV</h2>
                        ...
                        <div class="h-0 flex-1 overflow-y-auto">
                            <div class="flex flex-1 flex-col justify-between">
                                <div class="p-4 sm:p-6">
                                        ...
                                        x-data="{
                                            ...
                                            <div class="space-y-1 text-center">
                                                ...
                                                <p class="text-xs text-gray-500">
                                                    Arquivo CSV até 50MB
                                                </p>
                                            </div>
                                        </div>
                                    </div>

                                    @error('file')<span class="mt-2 text-red-500 font-medium text-sm">{{ $message }}</span>
                                    @enderror
                                    <!-- End file drop -->
                                    ...
                                    @if ($fileHeaders)
                                        <div class="mt-8">
                                            <h2 class="font-medium">Selecione as colunas</h2>
